...
for(let i = 0; i < 50; i++){
    ...
    grave.rotation.y = (Math.random() - .5) * 1
    grave.rotation.z = (Math.random() - .5) * 1
...
ghost1.shadow.mapSize.height = 256
ghost1.shadow.mapSize.height = 7

ghost2.shadow.mapSize.height = 256
ghost2.shadow.mapSize.height = 256
ghost2.shadow.mapSize.height = 7

ghost3.shadow.mapSize.height = 256
ghost3.shadow.mapSize.height = 256
ghost3.shadow.mapSize.height = 7
...
const tick = () =>
{
    ...
    ghost3.position.y = Math.sin(elapsedTime * 3) + 7 + Math.sin(elapsedTime * .32)
